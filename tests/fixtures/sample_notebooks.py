...
def get_sample_cells() -> List[Dict[str, Any]]:
    ...
    return [
        {"cell_type": "markdown", "source": CELL_MARKDOWN_HEADER, "metadata": {}},
        {
            "cell_type": "code",
            "execution_count": 1,
        ...
        {"cell_type": "markdown", "source": CELL_MARKDOWN_NOTES, "metadata": {}},
        {
            "cell_type": "code",
            "execution_count": 4,
...
def get_measureit_cells() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "source": CELL_CREATE_INSTRUMENT,
            "outputs": [
                {"output_type": "stream", "text": "Created instrument: mock_dac\n"}
            ],
        },
        {
            "cell_type": "code",
            ...
            "outputs": [
                {"output_type": "stream", "text": "Sweep completed: 11 points\n"}
            ],
        },
    ]
