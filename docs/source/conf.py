...
latex_documents = [
    ('index', 'instrMCP.tex', 'InstrMCP Documentation',
     'Jiaqi Cai', 'manual'),
]
...
man_pages = [
    ('index', 'instrmcp', 'InstrMCP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    ('index', 'instrMCP', 'InstrMCP Documentation',
     author, 'instrMCP', 'MCP server suite for physics laboratory instrumentation control',
     'Miscellaneous'),
]
