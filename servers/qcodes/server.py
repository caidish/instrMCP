        ...
        async def inst_health(name: str, update: bool = True) -> List[TextContent]:
            ...
            try:
                ...
                if not self.station_manager.station:
                    ...
                    snapshot = self.station_manager.get_instrument_snapshot(name, update=update)
                    result = {
                        "instrument": name,
                        "snapshot": snapshot,
                        "update": update,
            ...
            try:
                ...
                if instrument is None:
                    ...
                    result = {
                        ...
                        "parameters": list(instrument.parameters.keys()) if hasattr(instrument, 'parameters') else [],
                        "status": "success"
                    }
    ...
    async def initialize_server(self):
        ...
        try:
            ...
            if load_results:
                ...
                logger.info(f"Auto-load complete: {success_count}/{total_count} instruments loaded")
            else:
